...
const BusinessCard = ({ dev }: { dev: Dev }) => {
  ...
  useEffect(() => {
    const img = new Image();
    img.src = dev.fotografia || "https://wtmsantacruz-135e0.web.app/logo/wtm.png"; // Imagen por defecto si no hay foto
    ...
    <div className="w-[85mm] h-[55mm] bg-white dark:bg-gray-800 rounded-lg shadow-lg p-4 flex flex-col justify-between relative overflow-hidden">
      ...
      <div className="flex flex-col items-center z-10 space-y-0">
        ...
        <div className="w-20 h-20 rounded-full overflow-hidden mb-0">
          {imageLoaded ? (
            <img
              src={dev.fotografia || "https://wtmsantacruz-135e0.web.app/logo/wtm.png"} // Imagen por defecto si no hay foto
      ...
      <div className="absolute top-2 right-2 w-12 h-12 z-10">
        <img
          src="https://wtmsantacruz-135e0.web.app/logo/wtm.png"
          alt="WTM Logo"
      ...
      <div className="absolute top-2 left-2 w-12 h-12 z-10">
        <img
          src="https://wtmsantacruz-135e0.web.app/logo/gdg.png"
          alt="GDG Logo"
          className="w-full h-full object-contain"
        />
      </div>
      ...
      {/* QR Code */}
          ...
          {imageLoaded ? (
            <img
              src={dev.qr || "https://wtmsantacruz-135e0.web.app/logo/wtm.png"} // Imagen por defecto si no hay foto
              alt={dev.nombre_completo}
              className="w-full h-full object-cover"
            />
          ) : (
